...
11. **(Plan-mode handoff)** Steps 0–10 above constitute the planning phase (always run in plan mode; `EnterPlanMode` was called in step 0 if needed). After `ExitPlanMode` grants approval:
