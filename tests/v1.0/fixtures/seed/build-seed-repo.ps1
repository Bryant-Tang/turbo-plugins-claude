...
#
# 產出:
#   tests/v1.0/fixtures/seed/svn-repo-r1-r20.dump
#
# 流程:
...
# ─── 25 條中文字典 — keep in sync with docs/test-plans/v1.0/phase1-scripts.md ──
#
...
# 這個 mapping 由 docs/test-plans/v1.0/phase1-scripts.md 開頭 inline 表參照。
