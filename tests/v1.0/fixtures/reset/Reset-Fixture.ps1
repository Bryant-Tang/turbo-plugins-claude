...
# Reset-Fixture.ps1 lives at: <repo>/tests/v1.0/fixtures/reset/Reset-Fixture.ps1
# base/   ->  ../base
# seed/   ->  ../seed
...
Run tests/v1.0/fixtures/seed/build-seed-repo.ps1 first (or pass -SkipSvn to reset only the workspace mirror).
"@
}
