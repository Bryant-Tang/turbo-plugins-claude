...
$scriptUnderTest = [System.IO.Path]::Combine($repoRoot, 'plugins', 'turbo-plugin', 'scripts', 'push-to-svn-commit.ps1')
...
try {
    ...
    $zhMsg = '修正中文 bug — Phase 1 push-commit precondition case'
