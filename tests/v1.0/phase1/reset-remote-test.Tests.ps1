...
#
# Setup uses shared `_Common.ps1` helpers in this phase1/ dir.
...
$scriptUnderTest = [System.IO.Path]::Combine($repoRoot, 'plugins', 'turbo-plugin', 'scripts', 'reset-remote-test.ps1')
