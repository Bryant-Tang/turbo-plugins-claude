...
$ScriptUnderTest = [System.IO.Path]::Combine($repoRoot, 'plugins', 'turbo-plugin', 'scripts', 'build-web.ps1')
...
$script:Passed++
Write-Output '  [PASS] case4 (SKIP): real MSBuild build deferred to Phase 2 SKILL — too heavy + network for Phase 1'
