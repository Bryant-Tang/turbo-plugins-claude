...
#
# Phase 1 — script: plugins/turbo-plugin/scripts/compute-project-identity.ps1
#
# Cases:
...
#
# 規定:
#   - hand-rolled Assert-* via Assert-Helpers.ps1 dot-source
#   - 不修改 plugins/turbo-plugin/scripts/...
#   - 沙盒目錄走 C:\Turbo\turbo-plugin-test-<purpose>-<guid>;避免 %TEMP% 的 PS 5.1 8.3 short-name 問題
...
$ScriptUnderTest = [System.IO.Path]::Combine($repoRoot, 'plugins', 'turbo-plugin', 'scripts', 'compute-project-identity.ps1')
