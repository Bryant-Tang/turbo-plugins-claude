...
#
# 讀 docs/test-plans/v1.0/phase1-scripts.md 的 tracking row,統計 PASS / FAIL /
# FAIL-known / SKIP / BLOCKED-BY 各幾個,輸出 console summary,並回傳合適 exit code。
#
...
#
# 用法:
#   & .\Get-Phase1Status.ps1 -TargetDoc 'docs/test-plans/v1.0/phase1-scripts.md'
