...
# section 下方。Schema 對應 docs/test-plans/v1.0/phase1-scripts.md 的 `## Tracking
# schema` 段:
#
...
#     -Result    'PASS' `
#     -Evidence  'tests/v1.0/_artifacts/phase1/svn-log/zh.nunit.xml' `
#     -TargetDoc 'docs/test-plans/v1.0/phase1-scripts.md'
